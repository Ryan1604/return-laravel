                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <label class="form-radio-label">
                                                <input class="form-radio-input" type="radio" name="ebook_available" id="available" value="1" {{ old('ebook_available') == '1' ? 'checked' : '' }}>
                                                <span class="form-radio-sign">Available</span>
                                            </label>
                                            <label class="form-radio-label ml-4">
                                                <input class="form-radio-input" type="radio" name="ebook_available" id="unavailable" value="0" {{ old('ebook_available') == '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group" id="ebook-parent" style="@error('ebook_url') @else display:none @enderror">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control form-control-sm @error('rack_id') is-invalid @enderror" name="rack_id" id="rack">
                                                    ...
                                                    @foreach ($racks as $rack)
                                                        <option value="{{ $rack->id }}" {{ old('rack_id') == $rack->id ? 'selected' : '' }}>{{ $rack->position }} - {{ $rack->category->name }}</option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-sm @error('total_qty') is-invalid @enderror" name="total_qty" id="total_qty" value="{{ old('total_qty') }}" placeholder="Input here...">
