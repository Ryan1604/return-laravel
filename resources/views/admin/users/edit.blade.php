                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('sn') is-invalid @enderror" id="sn" name="sn" value="@error('sn'){{ old('sn') }}@else{{ $user->sn }}@enderror" placeholder="Enter Serial Number..." autocomplete="off">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="@error('name'){{ old('name') }}@else{{ $user->name }}@enderror" placeholder="Enter name..." autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" value="@error('phone_number'){{ old('phone_number') }}@else{{ $user->phone_number }}@enderror" placeholder="Enter phone number..." autocomplete="off">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control @error('dob') is-invalid @enderror" id="dob" name="dob" value="@error('dob'){{ old('dob') }}@else{{ $user->dob }}@enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control @error('faculty_id') is-invalid @enderror" name="faculty_id" id="faculty">
                                                    <option value="" selected>-- UNCLASSIFIED</option>
                                                        @foreach ($faculties as $faculty)
                                                            <option value="{{ $faculty->id }}" {{ old('faculty_id') == $faculty->id || $user->faculty_id == $faculty->id ? 'selected' : '' }}>{{ $faculty->name }}</option>
                                                        @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address" placeholder="Input here..." rows="5">@error('address'){{ old('address') }}@else{{ $user->address }}@enderror</textarea>
